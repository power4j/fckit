...
import com.power4j.fist.boot.mon.DefaultApiDescriptionResolver;
...
public class ApiLogConfig {
	...
	public ApiLogAspect apiLogAspect(ExceptionTranslator translator) {
		return new ApiLogAspect(new DefaultApiDescriptionResolver(), translator, () -> Optional.of(new UserInfo()));
	}
